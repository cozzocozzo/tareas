...
public class Ventanita extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Introduzca su peso");

        jLabel2.setText("Introduzca su altura");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setPeso(Float.parseFloat(jTextField1.getText()));
        a.setAltura(Float.parseFloat(jTextField2.getText()));
        
        Conversion c= new Conversion();
        c.setPeso(p);
        c.setAltura(a);
        jLabel3.setText(""+c.alturaporpeso() );
